      ...
      >
        <div className="relative w-full h-[230px]">
          <img
            src={image}
            alt={name}
            className="2-full h-full object-cover rounded-2xl"
          />
          <div className="absoulte inset-0 flex justify-end m-3 card-img_hover">
            <div
              onClick={() => window.open(source_code_link, "_blank")}
              className="black-graidnet w-10 h-10 rounded-full flex justify-center items-center cursor-pointer"
            >
              <img
                src={github}
                alt="github"
